...
@section('content')
    <div class="content" style="text-align: justify">
        ...
        <p><em><span style="text-decoration: underline;"><strong>PRIMERA.- EL DEUDOR</strong></span></em><em> declara ser legítimo propietario de un {{strtoupper($garment->article)}} Marca: {{$garment->brandGarment}}, Modelo: {{$garment->modelGarment}}.</em> {!! $garment->articleDescription !!}</p>
