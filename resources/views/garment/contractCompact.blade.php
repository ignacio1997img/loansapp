...
@section('content')
    <div class="content" style="text-align: justify">
        ...
        <p><em>En los registros de escritura que corren a su digno cargo, sírvase insertar una de transferencia con pacto de rescate de un {{strtoupper($garment->categoryGarment)}} de acuerdo a las siguientes cláusulas: </em></p>
